...
/*   Updated: 2022/01/03 01:53:41 by wluong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ClapTrap::attack( std::string const & target ) {
	if (this->_hitPoint > 0) {
		std::cout << "🤖 " << BLUE << this->getName() << NOR << " using ClapTrap attack " << BLUE << target << NOR \
...
void			ClapTrap::attack( ClapTrap & target ) {
	...
	if ( this->_hitPoint > 0 && target.getEnergyPoint() > 0 && this->_energyPoint) {
		std::cout << "🤖 " << BLUE << this->getName() << NOR << " using ClapTrap attack " << BLUE << target.getName() << NOR \
		<< " causing " << RED << this->_attackDmg << NOR << " points of damage ! 💥" << std::endl;

...
/*   Updated: 2022/01/08 03:33:14 by wluong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main() {
	...
	try {
		...
		Intern	NUL;
		Form	*UNKNOW;
		UNKNOW = NUL.makeForm("unexistant form", "swimming pool");
	}
	...
	try {
		...
		Intern		BOLOSS;
		Form	*F;
		F = BOLOSS.makeForm("shrubbery creation", "maison");
		std::cout << A << std::endl;
		std::cout << B << std::endl;
		std::cout << C << std::endl;
		std::cout << *F << std::endl;
	...
	try {
		...
		Intern		MISKIN;
		Form		*M;
		M = MISKIN.makeForm("robotomy request", "hospital");
		std::cout << D << std::endl;
		std::cout << E << std::endl;
		std::cout << F << std::endl;
		std::cout << G << std::endl;
		...
		Intern		UNLOVED;
		Form		*P;
		P = UNLOVED.makeForm("presidential pardon", "galaxy");
		std::cout << J << std::endl;
		std::cout << K << std::endl;
		std::cout << L << std::endl;
		std::cout << *P << std::endl;
